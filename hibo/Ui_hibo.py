...
class Ui_hibo(QtGui.QDialog):
	...
	self.connect(self.zoomoutRaster, QtCore.SIGNAL('triggered()'), self.showdlg)
	#self.connect(self.canvasRaster.mapCanvasRefreshed, self.refreshed)
